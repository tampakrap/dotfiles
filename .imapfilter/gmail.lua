...
gmail_unseen:match_from('(accounts@oreilly|(invitation-)?do-not-reply@(trello|stack(exchange|overflow))|(admin|notifications)@transifex|reddit@reddit|no-reply@(dropbox|socghop\\.appspotmail|lanyrd|susestudio|gitlab\\.uservoice)|payments-noreply@google|account-security-noreply@account\\.microsoft|notice-5622092@no-ip|gitlab@(mg\\.)?gitlab|ebay@ebay|(issue-updates|tickets|noreply|forge)@puppetlabs|(noreply|notification\\+ka4k2g4a)@facebookmail|(miles\\.bonus|echeckin|noreply|boardingpass)@aegeanair|service@(intl\\.paypal|payu)|webmaster@novell|mantis@public\\.kitware|support@olx|donotreply@gravatar|(passwordhelp|donotreply)@wordpress|alerts@citibank|notify@twitter|noreply(-www@services\\.|@(notifications\\.)?)swiss|youtube|(info@advisory\\.|itinerary@)ryanair|(bme@mailer\\.|customer\\.service@)booking|prague_harfa_(admin|msm)@jatomi|info@opprtunity|sklep@5zywiolow|issue-updates\\+[a-zA-Z]+@puppet|info@myopportunity|orders@eventbrite|service@liftago)\\.com|(notify@keybase|support@drone|support@virt|noreply@groups)\\.io|(support@cacert|accounts@fedoraproject|donotreply@rubygems|noreply@(redmine|wordpress)|no-reply@(persona|mozillians)|.*@bitbucket|bugzilla_noreply@kde|(do-not-reply|noreply|certification)@linuxfoundation)\\.org|(no_reply@gopay|(info|robot)@jidloted|zakaznici@damejidlo|noreply@c(sas|inemacity)|eshop_noreply@dpp|obchod@ticketportal|ticket@ticketpro|letenky@pelikan|reservation@previo|express@studentagency|info@goout|info@rb|noreply@linuxdays)\\.cz|no-reply@jetpack\\.me|(no-reply@vodafonecu|info@flowernet|billing@ziz|(billing|info|support)@papaki|hmaster-info@ics\\.forth|paycenter@piraeusbank|sales@astra-airlines)\\.gr|((fahrkartenservice|buchungsbestaetigung|verspaetungsalarm)@bahn|(info@|puppetcamp\\.teilnehmer@rt\\.)netways)\\.de|(ipv6@he|invite@brandedme)\\.net|(invitations|noreply)@angel\\.co'):move_messages(gmail['logs'])
...
gmail_unseen:match_from('(noreply@(mailer\\.atlassian|bitlysupport)|oreilly@post\\.oreilly|contact@puppetlabs|(Miles(&|\\+)Bonus|newsletter)@email\\.aegeanair|no-reply@dropboxmail|linkedin@e\\.linkedin|(Microsoft@e-mail|email@microsoft|msa@communication)\\.microsoft|(alerts(7)?|noreply3)@email(s)?\\.skype|(news|support|noreply|sytse|contact|community)@gitlab(control)?|info@smartwings|eBay@reply1\\.ebay|update\\+ka4k2g4a@facebookmail|(privacy-noreply|ingress-support)@google|e(-info|vents)@suse|invite@eventbrite|alerts@lanyrd|paypal@e\\.paypal|taco@trello|support@transifex|czech@jatomi|subscribe@saltstack|notices@slashdotmedia|unic.greece@gmail|krystof\\.raska@liftago|info@twitter)\\.com|(newsletter@arbes(dent|plus)|(mailing|newsletter)@pelikan|announce@linuxdays|info@installfest|novinky@jidloted|(newsletter@info\\.|directmail@)csa|newsletter@clubcard|newsletter@news\\.cinemacity|mamhlad@damejidlo|jaromir@musicbar)\\.cz|((career|cs-news|carseniou)@teilar|(support|info|no-reply)@ziz|[Ww]ebmaster@[Tt]helab|noreply@gtvs|(noreply|Estatements)@eurobank|specials@flowernet|info@ellak|phplist-bounces@eellak|(hello|newsletter)@airtickets)\\.gr|((noreply|sales)@mailer\\.bitbucket|admin@fedoraproject|(events|no-reply)@linuxfoundation)\\.org|(noreply@hetzner-status|news@netways)\\.de|newsletter@linuxcounter\\.net'):move_messages(gmail['newsletters'])
