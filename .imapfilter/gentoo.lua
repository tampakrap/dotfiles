...
spam = gentoo_unseen:match_field('X-Spam-Flag', 'YES') + gentoo_unseen:match_from('(goldenmarketing|qnews|traficfcs|panel25|payapars|simedi)\\.ir|(planetfone\\.com|pbh\\.gov)\\.br|(poworsave|waimaoedm|newageink|zyoux|allarelbus|messbest|richvalvee|powersqve|plazatur|ac2tech)\\.com|promofast\\.info|(cp-mi|miks-it|bk)\\.ru|(ussolardept|amazonclickhere)\\.eu|zeraimundo1515\\.net|almanet\\.tk|(flywer|lwtyui)\\.asia|successex\\.xyz')
spam:move_messages(gentoo['spam'])

hosting_all = '(infra-(4launch|eukhost|globalsign|hetzner|mti|rackspace|rax|vr)@gentoo|(support|hosting)@osuosl)\\.org|communication@magic\\.fr|s(ales|upport)@7l\\.com'
